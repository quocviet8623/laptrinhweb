...
<body>
            ...
            <div class="ReactModal__Content ReactModal__Content--after-open ewallet-modal" tabindex="-1" role="dialog"
                ...
                <div class="styles__StyledQR-sc-17o5jhk-0 jaZqMN">
                    <div class="qr-heading">
                        <h3 class="qr-heading__title"><img src="image/vnpay.png" alt="icon" width="32" height="32">Thanh toán
                            bằng VNPAY-QR</h3>
                        <div class="qr-heading__btn"><a href="cart.php">Đổi phương
                                thức khác</a></div>
                    </div>
                        ...
                        <div class="qr-content__right">
                            <div class="qr-content__desc">
                                ...
                                <div class="step-description"><span class="step-number">1</span>
                                    <p>Mở <b>ứng dụng ngân hàng hỗ trợ VNPAY-QR</b> trên điện thoại</p>
                                </div>
                                <div class="step-description"><span class="step-number">2</span>
                                    <p>Trên ứng dụng chọn tính năng<img
                                            src="image/quet.png"
    ...
    <style>
        ...
        .jaZqMN .supported-bank {
            padding: 24px;
            border-top: 1px solid rgb(235, 235, 240);
        }

        .jaZqMN .supported-bank__title {
            font-size: 16px;
            line-height: 24px;
            font-weight: 500;
            color: rgb(56, 56, 61);
        ...
        .jaZqMN .supported-bank__title img {
            margin-left: 8px;
        }

        .jaZqMN .supported-bank__list {
            display: grid;
        ...
        .jaZqMN .supported-bank__list img {
            object-fit: contain;
        }

        img[Kiểu thuộc tính] {
            width: 72px;
            aspect-ratio: auto 72 / 36;
            height: 36px;
        }
    </style>
</body>
