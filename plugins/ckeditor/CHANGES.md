...
* [#9772](http://dev.ckeditor.com/ticket/9772): Custom buttons in the dialog window have different look and size ([Moono](http://ckeditor.com/addon/moono), [Kama](http://ckeditor.com/addon/kama) skins).
